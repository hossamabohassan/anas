...
export default function App() {
  ...
  // Play audio for current question when it changes
  // Note: The original GameScreen handles playing on mount, but we ensure the correct file/text is used
  // We updated GameScreen to just call speak(text), audioService handles the file lookup now.
